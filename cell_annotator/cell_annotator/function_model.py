...
from tensorflow.keras.applications import DenseNet201,ResNet101,ResNet152
...
folder_code="/home/slimane/Desktop/design project/Classification"
sys.path.append(os.path.join(folder_code,date_str+' compteur'))

sys.path.append('/home/slimane/Desktop/design project/slimane_lio/libraries')
...
def create_model(archi,input_shape=[84,84,3], nb_classes=2, pre_train=None,
    ...
    if archi==archis[0]:
        ...
        model = ResNet152V2(include_top=False, weights=pre_train, input_tensor=None,
